...
CREATE TABLE "invites" (
    ...
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "user_id" TEXT,
    "ornaginaztion_id" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "invites_email_ornaginaztion_id_key" ON "invites"("email", "ornaginaztion_id");
...
-- AddForeignKey
ALTER TABLE "invites" ADD CONSTRAINT "invites_ornaginaztion_id_fkey" FOREIGN KEY ("ornaginaztion_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_ornaginaztion_id_fkey" FOREIGN KEY ("ornaginaztion_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
